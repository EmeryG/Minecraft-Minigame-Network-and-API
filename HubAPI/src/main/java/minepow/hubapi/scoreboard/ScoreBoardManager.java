...
public class ScoreBoardManager {
	...
	public static void updateScoreBoard(Player player){
		...
		//Setting some scores
		title.getScore(ChatColor.GOLD + "" + ChatColor.BOLD + "PowMoney:").setScore(15);;
		title.getScore(ChatColor.AQUA + "" + ChatColor.BOLD + EconomyManager.getCurrentMoney(player)).setScore(14);;
	}
